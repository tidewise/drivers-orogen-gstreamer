...
namespace gstreamer {
    ...
    protected:
        ...
        void configureOutput(GstElement* pipeline, OutputConfig const& config, bool dynamic, FrameOutputPort& port);
        void configureInput(GstElement* pipeline, InputConfig const& config, bool dynamic, FrameInputPort& port);
